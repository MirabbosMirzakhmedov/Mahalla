    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(default='../../media/posts/default.webp', upload_to='posts/')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='neighbors_posts', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
